package com.isk.iskdemo.Classes.Misc;
...
public class Crypto {
	 ...
	 * @return The AES and HMAC keys.
	 * @throws GeneralSecurityException Yes it does
	 */
	...
	public static final class PrngFixes {
		...
		private static void applyOpenSSLFix() throws SecurityException {
			...
			try {
				...
				Class.forName("org.apache.harmony.xnet.provider.jsse.NativeCrypto")
						.getMethod("RAND_seed", byte[].class).invoke(null, (Object) generateSeed());
		...
		private static void installLinuxPRNGSecureRandom() throws SecurityException {
			...
			synchronized (java.security.Security.class) {
				...
				if (!Objects.requireNonNull(rng2).getProvider().getClass().getSimpleName().equals("LinuxPRNGSecureRandomProvider")) {
					if (ALLOW_BROKEN_PRNG) {
						Log.w(PrngFixes.class.getSimpleName(),
